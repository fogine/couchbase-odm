...
Model.prototype.getById = function(id, options) {
    ...
    if (options.hooks === true) {
        promise = this.runHooks(HookTypes.beforeGet, key);
    } else {
    ...
    return promise.bind(this).then(function() {
        ...
        return this.runHooks(HookTypes.afterGet, doc);
    });
...
Model.prototype.getMulti = function(ids, options) {
    ...
    if (runHooks !== false && options.individualHooks !== true) {
        promise = this.runHooks(HookTypes.beforeGet, ids).return(ids);
    } else {
    ...
    return promise.map(function(id) {
        ...
        if (runHooks !== false && options.individualHooks !== true) {
            return self.runHooks(HookTypes.afterGet, out);
        }
    });
}
