 ...
 * @param {Key}     [options.refDocKey=RefDocKey] - The strategy used for reference document `key` generation. Must inherit from base `Key` class
...
Model.prototype.$init = function(modelManager) {
    ...
    var report = sanitizer.sanitizeSchema(this.options.schema, modelManager);
