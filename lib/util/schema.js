...
function addTimestampProperties() {
    ...
    schema[timestampPropNames.createdAt] = {instanceof: 'Date'};
    schema[timestampPropNames.updatedAt] = {instanceof: 'Date'};

    if (paranoid === true) {
        schema[timestampPropNames.deletedAt] = {instanceof: 'Date'};
    }
