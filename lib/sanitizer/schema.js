...
function sanitize(schema, report, modelManager, propertyPath) {
    ...
    sanitizeDefaultPropertyValue(schema, report, modelManager, propertyPath);
 ...
 * @private
 */
function sanitizeDefaultPropertyValue(schema, report, modelManager, propertyPath) {
    ...
    report.setSchemaPropertyDefaultValue(schema.default, propertyPath);
}
